...
class TouchControls extends Component with HasGameReference<MyGame> {
  ...
  static const double horizontalMargin = 100.0;

  /// Vertical margin from bottom of screen
  static const double bottomMargin = 120.0;
  ...
  Future<void> onLoad() async {
    ...
    aimJoystick = JoystickComponent(
      knob: CircleComponent(
        radius: knobSize,
        paint: Paint()
          ..color = const Color(0xCC00FFFF), // Cyan tint for shooting
      ),
