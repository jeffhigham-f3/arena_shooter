...
class MyGame extends FlameGame
  ...
  /// Check if running on a touch-enabled platform (iOS/Android)
  ...
  Future<void> onLoad() async {
    ...
    // Add touch controls only on touch-enabled platforms (iOS/Android)
    if (_isTouchPlatform) {
      touchControls = TouchControls();
      add(touchControls!);
    }
  ...
  void update(double dt) {
    ...
    if (touchControls != null && _gameState == GameState.playing) {
      ...
      player.setJoystickAim(
        touchControls!.aimDirection,
        touchControls!.isShooting,
      );
    }
  }
